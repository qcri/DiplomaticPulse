...
class TestHtmlUtils(unittest.TestCase):
    ...
    def test_get_text_from_html_soup(self):
        """
        We pass respnse,xpaths, driver to get_text_from_html_soup and expect text
        """
        ...
        xpath = 'div,ms-rtestate-field'
        result = util.get_text_from_html_soup(response, xpath, driver)
        expected = 'Upon completion of the Australian move, any activities on behalf of Australia'
