...
class TestHtmlUtils(unittest.TestCase):
    """
    Class containing the test suite for get_title_from_html_soup().
    ...
    def test_get_title_from_html_soup(self):
        """
        We pass respnse,xpaths, driver to get_title_from_html_soup and expect text
        """
        ...
        result = util.get_title_from_html_soup(response, 'mytitle', xpath,driver)
        expected = 'mytitle'
